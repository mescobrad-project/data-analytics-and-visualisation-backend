...
def train_eval_model(train_dataloader, eval_dataloader, model, lr, patience):
    ...
    for epoch in range(n_epochs):
        ...
        print(f'epoch {epoch+1} - train loss {train_loss:.3f} - val loss {valid_loss:.3f} - val f1 {dev_f1:.3f} - val acc {dev_acc:.3f}')
        ...
        if patience_counter == patience:
            ...
            print(f'Early Stopping checkpoint at epoch {es_epoch}. Patience value was {patience}.')
            print('Train-Eval stage complete!')
            ...
            print('Training on eval data complete!')
