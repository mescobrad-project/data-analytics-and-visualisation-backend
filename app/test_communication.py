...
def test_complete_step_success():
    # First test
    assert 200 == 200

def test_upload_data_general_success():
    # First test
    assert 200 == 200

def test_upload_data_mri_success():
    # First test
    assert 200 == 200

def test_upload_data_group_success():
    # First test
    assert 200 == 200

def test_function_navigation_success():
    # First test
    assert 200 == 200

def test_function_navigation_group_success():
    # First test
    assert 200 == 200
